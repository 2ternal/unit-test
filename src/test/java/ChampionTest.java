...
public class ChampionTest {
    ...
    public void testForRelatedString() {
        ...
        assertThat(sampleString2, anyOf(startsWith("Player"), endsWith("Focus")));
    }
    ...
    public void shouldHaveSomeChampName() {
        ...
        assertThat(champListNames.get(2), containsString("렉사"));
    }
    ...
    public void shouldTopChampionIsDarius() {
        Optional<Champion> filleredChampion = championList.stream()
                .filter(c -> c.getPosition().equals("탑"))
                .findFirst();

        assertThat(filleredChampion.get().getName(), is("다리우스"));
        assertTrue(filleredChampion.get().getPosition().equals("탑"));
        System.out.println("champ :: " + filleredChampion);
    }
